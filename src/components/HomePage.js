    ...
    <div>
      ...
      <div className='home-page section-center'>
        <div className='home-page-mexico'>
          ...
          <p>
            ENJOY THE VIBRANT ATMOSPHERE, COLORFUL DECOR, AND THE WARMTH OF OUR
            HOSPITALITY, PROVIDING THE PERFECT BACKDROP FOR AN UNFORGETTABLE
            DINING EXPERIENCE.
          </p>
          <p>
            JOIN US SOON FOR A TASTE OF MEXICO; WE CAN'T WAIT TO WELCOME YOU AND
            SHARE OUR PASSION FOR DELICIOUS, AUTHENTIC FOOD.
          </p>
        </div>
        <div className='home-about'>
          <article className='home-about-content'>
            ...
            <p>
              ...
              location. Mi Mexico is a family run business perfect for
              ...
              atmosphere of Mi Mexico is a perfect to place relax. ​ Come in an
